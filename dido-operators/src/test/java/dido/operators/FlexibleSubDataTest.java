...
class FlexibleSubDataTest {
    ...
    void testEqualsHashCodeAndToString() {
        ...
        DidoData subData1 = FlexibleSubData.ofIndices(1, 3).apply(data1);

        assertThat(subData1.getSchema().toString(), is("{[1:Name]=java.lang.String, [3:Colour]=java.lang.String}"));
        assertThat(subData1.toString(), is("{[1:Name]=Alice, [3:Colour]=Green}"));

        DidoData data2 = MapData.of(
                        "Name","Alice", "Number", 4567, "Colour", "Green");

        DidoData subData2 = FlexibleSubData.ofIndices(1, 3).apply(data2);
    ...
    void testWithOneSubField() {
        ...
        DidoData subData1 = FlexibleSubData.ofIndices(1).apply(data1);
        ...
        DidoData subData2 = FlexibleSubData.ofIndices(3).apply(data2);

        assertThat(subData2.getSchema(), is(SchemaBuilder.newInstance()
                .addNamedAt(3, "Name", String.class)
                .build()));
        assertThat(subData2, is(subData1));
        assertThat(subData2.hashCode(), is(subData1.hashCode()));
    }
    ...
    void testSubDataWithFieldNames() {
        ...
        DidoData subData1 = FlexibleSubData.ofFields("Name").apply(data1);
        ...
        DidoData subData2 = FlexibleSubData.ofFields("Called").apply(data2);
