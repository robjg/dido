...
class SubDataTest {
    ...
    void byFields() {
        ...
        DataSchema expectedSchema = ArrayData.schemaBuilder()
                .addNamedAt(1, "Id", String.class)
                .addNamedAt(5, "Colour", String.class)
                .build();

        assertThat(subData.getSchema(), is(expectedSchema));
    }
    ...
    void fieldsOut() {
        ...
        FieldValuesOut valuesOut = FieldValuesOut.forSchema(subData.getSchema());
