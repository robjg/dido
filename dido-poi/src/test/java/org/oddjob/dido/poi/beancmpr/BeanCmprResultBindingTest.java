...
import org.oddjob.dido.poi.OjTestCase;
...
public class BeanCmprResultBindingTest extends OjTestCase {
	...
	public void setUp() throws Exception {
		...
		workDir = OurDirs.workPathDir(BeanCmprResultBindingTest.class).toFile();
	}
